...
$0A  constant PSEL
                         \ SEL  DS REN DIR OUT
$00 constant INMODE-NR   \   0   0   0   0   X  Input
$04 constant INMODE-PD   \   0   0   1   0   0  Input with pulldown resistor
$05 constant INMODE-PU   \   0   0   1   0   1  Input with pulldown resistor
$02 constant OUTMODE-LS  \   0   0   X   1   X  Output with reduced drive strength
$0B constant OUTMODE-HS  \   0   1   X   1   1  Output with high drive strength
$12 constant OUTMODE-SP  \   1   0   X   1   X  Ouput reduced with special function
